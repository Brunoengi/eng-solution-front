...
export async function POST(request: Request) {
  ...
  const apiPath = process.env.ESTRUTURA_FRAME2D_API_PATH ?? '/frame2d/system';
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Erro ao conectar com API de pórtico plano.';
